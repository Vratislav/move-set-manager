...
const COLOR_2 = clr('red', 11, 'Color 2')
...
const COLOR_7 = clr('yellow', 4, 'Color 7')
const COLOR_8 = clr('yellow', 9, 'Color 8')
const COLOR_9 = clr('lime', 9, 'Color 9')
...
const COLOR_16 = clr('blue', 8, 'Color 16')
const COLOR_17 = clr('blue', 9, 'Color 17')
const COLOR_18 = clr('indigo', 10, 'Color 18')
const COLOR_19 = clr('iris', 11, 'Color 19')
const COLOR_20 = clr('blue', 11, 'Color 20')
...
const COLOR_25 = clr('crismon', 10, 'Color 25')
